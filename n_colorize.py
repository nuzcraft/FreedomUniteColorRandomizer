...
if __name__=='__main__':
    ...
    new_hue_white.saturation_shift = 0.3
    ...
    for idx, texture in enumerate(imgs):
        ...
        new_img = Image.fromarray(shift_hue(arr, new_hues, new_hue_white, rainbow, alter_white=False).astype('uint8'), 'RGBA')
